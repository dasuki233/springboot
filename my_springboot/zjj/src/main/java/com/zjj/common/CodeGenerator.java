...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir") + "/my_springboot/zjj";
        ...
        // ⼀、修改数据源
        dsc.setUrl("jdbc:mysql://localhost:3306/qgzx?useUnicode=true&characterEncoding=UTF8&useSSL=false");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("rikka233");
